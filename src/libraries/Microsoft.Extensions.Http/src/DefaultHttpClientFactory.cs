...
namespace Microsoft.Extensions.Http
{
    internal class DefaultHttpClientFactory : IHttpClientFactory, IHttpMessageHandlerFactory
    {
        ...
        private static readonly TimeSpan s_defaultCleanupInterval = TimeSpan.FromSeconds(10);
        ...
        internal virtual void StartCleanupTimer()
        {
            ...
            {
                _cleanupTimer ??= NonCapturingTimer.Create(_cleanupCallback, this, s_defaultCleanupInterval, Timeout.InfiniteTimeSpan);
            }
        }
